...
public class RegistroEquiposDatos {
    ...
    public RegistroEquiposDatos(Bitmap b1, Bitmap b2, String codigo, String nombre, String fecha, String marca, String modelo, String bolso, String equipoEnCaja, String cargador, String manualEnCaja, String garantiaEnCaja, String enciendeCargaSo, String monitorPoblemas, String audioProblemas, String touchPadProblemas) {
        this.b1 = b1;
        this.b2 = b2;
        this.codigo = codigo;
        this.nombre = nombre;
        ...
        this.modelo = modelo;
        this.bolso = bolso;
        this.EquipoEnCaja = equipoEnCaja;
        this.cargador = cargador;
        this.ManualEnCaja = manualEnCaja;
        this.GarantiaEnCaja = garantiaEnCaja;
        this.EnciendeCargaSo = enciendeCargaSo;
        this.MonitorPoblemas = monitorPoblemas;
        this.AudioProblemas = audioProblemas;
        this.TouchPadProblemas = touchPadProblemas;
